...
async function getStaticProps() {
  //fetch data from API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://dattocngan:doitruong@cluster0.ptlub.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
